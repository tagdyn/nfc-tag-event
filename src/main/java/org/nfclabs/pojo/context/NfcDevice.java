...
public class NfcDevice extends AbstractContextualObject implements INfcDevice
{
    protected String serialNumber;
    protected INfcDeviceType deviceType;
    ...
    @Override
    public INfcDeviceType getNfcDeviceType()
    {
        return deviceType;
    }
}
